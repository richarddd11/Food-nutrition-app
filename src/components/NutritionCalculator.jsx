...
const NutritionCalculator = () => {
  ...
  return (
    <section className='max-w-4xl mx-auto py-16 px-8 bg-white shadow-lg rounded-lg'>
      <h2 className='text-4xl font-semibold text-green-700 text-center mb-6'>Nutričná kalkulačka</h2>

      <form onSubmit={calculateCalories} className="grid grid-cols-1 md:grid-cols-2 gap-6 bg-gray-50 p-6 rounded-lg shadow-md">
        {/* Váha */}
        <div>
          ...
          <input 
            ...
            className="focus:outline-none border border-gray-300 rounded-lg px-4 py-2 w-full focus:ring-2 focus:ring-green-500 transition"
        ...
        <div>
          ...
          <select
            ...
            className='border border-gray-300 rounded-lg px-4 py-2 w-full focus:ring-2 focus:ring-green-500 transition'
          >
        ...
        <div className="col-span-2 flex justify-center">
          <button type="submit" className='bg-green-600 text-white px-6 py-3 rounded-lg hover:bg-green-700 transition text-lg font-semibold shadow-md'>
            Vypočítať kalórie
          </button>
        </div>
      </form>
